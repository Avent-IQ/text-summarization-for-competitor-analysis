# Text-to-Text Transfer Transformer Quantized Model for Text Summarization for Competitor Analysis
...
- **Task:** Text Summarization for Competitor Analysis
...
model_name = "AventIQ-AI/text-summarization-for-competitor-analysis"
